...
if (isset($_GET['ulozit'])) {
    ...
    try {
        $sql = "INSERT INTO formular_2 (email,vek,vaha, vyska,adresa,mesto,stat,psc,pohlavi) VALUES ('$zadanyEmail','$zadanyVek',
  ...
  <form action="" method="get">
    ...
    <div class="form-group">
      ...
      <div class="form-check form-check-inline">
        ...
        <label class="form-check-label" for="inlineRadio2">Žen</label>
      </div>
    </div>
